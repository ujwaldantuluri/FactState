...
TRUSTED_PAYMENT_PROCESSORS = [
    "paypal", "stripe", "razorpay", "paytm", "phonepe", "googlepay", 
    "amazonpay", "visa", "mastercard", "rupay", "upi"
]
...
async def _extract_business_info(html: str) -> Dict:
    ...
    text = html.lower() if not soup else soup.get_text(' ').lower()
    ...
    for gateway in TRUSTED_PAYMENT_PROCESSORS:
    ...
    if soup:
        ...
        # Fallback regex for social links
        social_patterns = [
        ...
        for pattern in social_patterns:
            ...
            info['social_links'].extend(matches)
